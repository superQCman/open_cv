...
def main():
    ...
    palm_model = cv.dnn.readNet('samples\models\palm_detection_mediapipe_2023feb.onnx')
    ...
    hand_model = cv.dnn.readNet('samples\models\handpose_estimation_mediapipe_2023feb.onnx')
